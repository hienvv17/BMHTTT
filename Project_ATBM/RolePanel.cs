...
namespace Project_BMHTTT
{
    public partial class RolePanel : Form
    {
        ...
        public RolePanel()
        {
            ...
            getUserList1.CommandText = "select distinct role from dba_roles order by role asc";
        ...
        private void btn_AddUser_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                commandCheckToTruong.CommandText = "pr_create_role";
                commandCheckToTruong.CommandType = CommandType.StoredProcedure;

                commandCheckToTruong.Parameters.Add(new OracleParameter("pi_rolename", OracleDbType.NVarchar2)).Value = txtNewRoleName.Text.Trim().ToUpper();// pwd.Text.Trim();
                try
                {
        ...
        private void btn_DelUser_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                commandCheckToTruong.CommandText = "pr_drop_role";
                commandCheckToTruong.CommandType = CommandType.StoredProcedure;

                commandCheckToTruong.Parameters.Add(new OracleParameter("pi_rolename", OracleDbType.NVarchar2)).Value = cbbDelRole.Text.Trim().ToUpper();// pwd.Text.Trim();
                try
                {
                    commandCheckToTruong.ExecuteNonQuery();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            getUserList1.CommandText = "select distinct grantee from dba_role_privs order by grantee asc";
